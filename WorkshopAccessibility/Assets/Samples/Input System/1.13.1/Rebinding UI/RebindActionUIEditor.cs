...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            m_actionOverideProperty = serializedObject.FindProperty("m_OverrideActionLabel");
            m_actionOverideStringProperty = serializedObject.FindProperty("m_actionLabelString");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                EditorGUILayout.PropertyField(m_actionOverideProperty);
                if (m_RebindActionUI.m_OverrideActionLabel)
                {
                    EditorGUILayout.PropertyField(m_actionOverideStringProperty);
                }
            }
        ...
        private SerializedProperty m_actionOverideProperty;
        private SerializedProperty m_actionOverideStringProperty;
